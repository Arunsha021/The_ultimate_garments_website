...
export default function RatingLogo(props){
      ...
      return (<div>
      <div style={{fontSize:30,fontWeight:700,lineHeight:'35px',mrginBottom:40,display:'flex',textAlign:'center',justifyContent:'center'}}> Rating & Reviews </div>
   ...
   <Grid item xs={3}>
     ...
     <img src={`${ServerURL}/images/milions.jpg`} style={{width:'35%',height:'auto',marginTop:17}} /><br/> <div style={{fontSize:17,padding:'10px',fontWeight:700}}> Happy Customers</div>
     </div>
    </Grid>
    </div>
