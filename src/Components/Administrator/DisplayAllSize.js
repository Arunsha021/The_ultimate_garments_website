...
export default function DisplayAllSize(props) {
  ...
  const handleEditSize = async () => {
    setOpen(false)
    var body = { categoryid: categoryId, subcategoryid: subCategoryId, productid: productId, size: size, sizeid: sizeId }
            ...
            <Grid item xs={6}>
              <FormControl fullWidth>
                ...
                >
                  ...
                  <MenuItem value="L Size">L Size</MenuItem>
                  <MenuItem value="XL Size">XL Size</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid item xs={6}>
