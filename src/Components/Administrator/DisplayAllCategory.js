      ...
      >
       ...
       <div >
          ...
          <Grid className={classes.gridStyle} container spacing={2}>
            ...
            <Grid item xs={6}>
         <Button  onClick={handleEditCategory} fullWidth color="primary" variant="contained">Edit</Button>
        </Grid>
        <Grid item xs={6}>
         <Button color="primary" onClick={handleDeleteCategory} fullWidth variant="contained">Delete</Button>
        </Grid>
